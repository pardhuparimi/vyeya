...
describe('authenticateToken middleware', () => {
  ...
  req = {
    ...
    get: () => undefined,
    header: () => undefined,
    accepts: jest.fn().mockReturnValue(false) as Request['accepts'],
    acceptsCharsets: jest.fn().mockReturnValue(false) as Request['acceptsCharsets'],
    acceptsEncodings: jest.fn().mockReturnValue(false) as Request['acceptsEncodings'],
    acceptsLanguages: jest.fn().mockReturnValue(false) as Request['acceptsLanguages'],
    range: () => undefined,
    accepted: [],
